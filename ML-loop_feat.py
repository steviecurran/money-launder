...
def ML(n_loops):
    ...
    for i in range(0,n_loops):
        print("On loop %d of %d" %(i, n_loops))
        ...
        del df['ID']
        set_orig = [target,'e_23456','e_64645','e_43568','e_11234','e_34454','CountDeposit','DifferentMethodWithdrawals']
        set_LR = [target,'CountPaymentMethod','e_64645','e_43568','IP_Counts','e_23456','e_34454','Is_Retail']
        set_SVC = [target,'e_23456','e_64645','e_43568','IP_Counts','Is_Retail','e_34454','CountPaymentMethod']
        set_kNN =[target,'e_23456','e_64645','e_43568','CountPaymentMethod','Is_Retail','e_11234','e_34454']
        set_DTC =[target,'CountWithdrawal','TotalDeposits','DifferentMethodWithdrawals','CountDeposit','e_23456','e_64645','IP_Counts']
        ...
        df = df[choice] 
        test_frac = 0.2; cv = 10; max_iter = 1000; 
        ## DROP TARGET
    ...
    # out = 'ML_loops=%d-feat_%s.csv'  %(n_loops,ext) # HAVE TRAINING SCORES
    out = 'ML_loops=%d-feat_%s-validation.csv'  %(n_loops,ext)
