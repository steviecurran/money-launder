...
df = pd.read_csv('ML_sampled_loops=100.csv'); #print(df)
...
x = SVC['n']; y = SVC['mean']; e = SVC['sd']; 
ax.errorbar(x, y, yerr=e, xerr=None, fmt='s', c = 'b', capsize=6)
ax.plot(x,y,c='b')

x = kNN['n']; y = kNN['mean']; e = kNN['sd']; 
ax.errorbar(x, y, yerr=e, xerr=None, fmt='s', c = 'g', capsize=6)
ax.plot(x,y,c='g')

x = DTC['n']; y = DTC['mean']; e = DTC['sd']; 
ax.errorbar(x, y, yerr=e, xerr=None, fmt='s', c = 'orange', capsize=6)
ax.plot(x,y,c='orange')

x = LR['n']; y = LR['mean']; e = LR['sd']; 
ax.errorbar(x, y, yerr=e, xerr=None, fmt='s', c = 'r', capsize=6)
ax.plot(x,y,c='r')

plt.text(1650,70.5,"SVG", fontsize = small, c = 'b')
plt.text(1650,69.5,"kNN", fontsize = small, c = 'g')
plt.text(1650,68.5,"DTC", fontsize = small, c = 'orange')
plt.text(1650,67.5,"LR", fontsize = small, c = 'r')

ax.set_xlabel('Number of each suspect and non-suspect players'); ax.set_ylabel('Mean score [%]')
